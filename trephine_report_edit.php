            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 text-capitalize">
                        <i class="fas fa-pen text-primary"></i> bone marrow trephine report (edit)
                    </h4>
                    <div class="">
                        <a href="<?php echo $url; ?>/trephine_report_create" class="btn btn-outline-primary">
                ...
                <?php
                $id = $_GET['id'];
                $currentReport = trephine_report($id);
                if (isset($_POST['tre_edit'])){
                    trephine_report_edit();
                }
                ?>

                <?php

                if (isset($_SESSION['tre_report_edit_status'])){
                    echo $_SESSION['tre_report_edit_status'];
                }
                ...
                <form action="" method="post">
                    <div class="row g-2">
                        <div class="col-md">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="">
                                    <input type="date" class="form-control" name="due_date" value="<?php echo $currentReport['sc_date']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" name="institute_name" class="form-control" id="institute_name" placeholder="institute_name" value="<?php echo $currentReport['institute_name']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="number" name="lab_access" class="form-control" id="lab_access" placeholder="lab_access" value="<?php echo $currentReport['lab_no']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" name="patient_name" class="form-control" id="patient_name" placeholder="patient_name" value="<?php echo $currentReport['patient_name']; ?>">
                            ...
                            <div class="mb-3">
                                <label for="">Age</label>
                                <div class="form-floating">
                                    <input type="number" name="age" class="form-control" id="age" placeholder="age" value="<?php echo $currentReport['age']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <?php foreach ($genderArr as $g){ ?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="<?php echo $g; ?>_id" name="gender" value="<?php echo $g; ?>" class="custom-control-input" <?php echo $currentReport['gender'] == $g ? 'checked':''; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="contact_detail" id="contact_detail" placeholder="Enter Contact Details" style="height: 130px"><?php echo $currentReport['address']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" name="physician_name" class="form-control" id="physician_name" placeholder="physician_name" value="<?php echo $currentReport['physician_name']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" name="doctor" class="form-control" id="doctor" placeholder="doctor" value="<?php echo $currentReport['doctor']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="clinical_history" id="clinical_history" placeholder="Enter clinical history" style="height: 130px"><?php echo $currentReport['cli_history']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="bmexamination" id="bmexamination" placeholder="Enter Indication for Bone Marrow Examination" style="height: 130px"><?php echo $currentReport['bmexamination']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <?php foreach ($tre_pro_performArr as $g){ ?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="<?php echo $g; ?>_id" name="pro_perform" value="<?php echo $g; ?>" class="custom-control-input" <?php echo $currentReport['pro_perform'] == $g ? 'checked':''; ?>>
                                        <label class="form-check-label" for="<?php echo $g; ?>_id">
                                            <?php echo $g; ?>
                                        </label>
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="anatomic_site_trephine" id="anatomic_site_trephine" placeholder="Enter Anatomic site of Aspirate / Trephine biopsy" style="height: 130px"><?php echo $currentReport['anato_trephine']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="biopsy_core" id="biopsy_core" placeholder="Enter Aggregate length of biopsy core" style="height: 130px"><?php echo $currentReport['biopsy_core']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="ade_macro_appearance" id="ade_macro_appearance" placeholder="Enter Adequacy And Macroscopic Appearance Of Core" style="height: 130px"><?php echo $currentReport['ade_macro_appearance']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="percentage_cellularity" id="percentage_cellularity" placeholder="Enter Percentage And Pattern Of Cellularity" style="height: 130px"><?php echo $currentReport['percentage_cellularity']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="bone_architecture" id="bone_architecture" placeholder="Enter Bone Architecture" style="height: 130px"><?php echo $currentReport['bone_architecture']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="path" id="path" placeholder="Enter Location" style="height: 130px"><?php echo $currentReport['location_from']; ?></textarea>
                        ...
                        <div class="col-md">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="number" name="tre_number" class="form-control" id="tre_number" placeholder="tre_number" value="<?php echo $currentReport['tre_number']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="erythroid" id="erythroid" placeholder="Enter Morphology And Pattern of Differentiation For Erythroid" style="height: 130px"><?php echo $currentReport['erythroid']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="myeloid" id="myeloid" placeholder="Enter Myeloid Lineages" style="height: 130px"><?php echo $currentReport['myeloid']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="megaka" id="megaka" placeholder="Enter Megakaryocytic Lineages" style="height: 130px"><?php echo $currentReport['megaka']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="lymphoid" id="lymphoid" placeholder="Enter Lymphoid Cells" style="height: 130px"><?php echo $currentReport['lymphoid']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="plasma_cell" id="plasma_cell" placeholder="Enter Plasma Cell" style="height: 130px"><?php echo $currentReport['plasma_cell']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="macrophages" id="macrophages" placeholder="Enter Macrophages" style="height: 130px"><?php echo $currentReport['macrophages']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="abnormal_cell" id="abnormal_cell" placeholder="Enter Abnormal cells and/or infiltrates" style="height: 130px"><?php echo $currentReport['abnormal_cell']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="reticulin_stain" id="reticulin_stain" placeholder="Enter Reticulin Stain" style="height: 130px"><?php echo $currentReport['reticulin_stain']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="immunohistochemistry" id="immunohistochemistry" placeholder="Enter Immunohistochemistry" style="height: 130px"><?php echo $currentReport['immu_histo']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="histochemistry" id="histochemistry" placeholder="Enter Histochemistry" style="height: 130px"><?php echo $currentReport['histochemistry']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="investigation" id="investigation" placeholder="Enter Other Investigations" style="height: 130px"><?php echo $currentReport['investigation']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="conclusion" id="conclusion" placeholder="Enter Conclusion" style="height: 130px"><?php echo $currentReport['conclusion']; ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="disease_code" id="disease_code" placeholder="Enter Disease Code" style="height: 130px"><?php echo $currentReport['disease_code']; ?></textarea>
                    ...
                    <hr>
                    <button class="btn btn-primary text-uppercase" name="tre_edit"><i class="fa fa-edit me-2"></i>Update</button>
                </form>
            </div>
        </div>
    </div>
